...
class RackDetailModal {
  static Future<void> show({
    ...
    required Function(int, String) onUpdateBin, // Callback to update bin
  }) {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _updateBin(Rack rack) async {
       final selectedBin = await showDialog<BinData>(
        ...
        if (selectedBin != null && mounted) {
          widget.onUpdateBin(rack.rackNo, selectedBin.binId);
          setState(() {
            // Force rebuild current widget to reflect logic, although parent update usually enough if logic works
          });
        }
    }
