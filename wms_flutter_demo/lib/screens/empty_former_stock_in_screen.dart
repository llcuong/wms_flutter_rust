...
class EmptyFormerStockInScreen extends StatefulWidget {
  const EmptyFormerStockInScreen({super.key});

  @override
  State<EmptyFormerStockInScreen> createState() => _EmptyFormerStockInScreenState();
}

class _EmptyFormerStockInScreenState extends State<EmptyFormerStockInScreen> {
  ...
  String get _rackCacheKey {
    return 'empty_stockin_rack_temp';
  }
